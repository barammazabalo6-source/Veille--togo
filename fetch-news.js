...
const URL_GENERAL = `https://newsdata.io/api/1/news?apikey=${API_KEY}&country=tg&language=fr&category=business`;
const URL_PORT = `https://newsdata.io/api/1/news?apikey=${API_KEY}&q=%22Port%20Autonome%20de%20Lom%C3%A9%22&language=fr`;
